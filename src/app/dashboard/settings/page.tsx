      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#FDFCFB] dark:bg-white/5 p-6 rounded-2xl border border-warmborder dark:border-white/10 shadow-sm transition-colors duration-300">
          <div className="flex items-center gap-1.5 mb-4">
            ...
            <h2 className="text-xs font-bold uppercase tracking-wider text-warmtext/50 dark:text-darktext/50">Preferences</h2>
          </div>

          <div className="flex items-center justify-between py-2">
            <div>
              <p className="text-sm font-bold text-warmtext/80 dark:text-darktext/80">Dark Theme</p>
              <p className="text-[11px] text-warmtext/50 dark:text-darktext/50 mt-0.5">Toggle interface appearance between light and dark modes.</p>
            </div>
            <ThemeToggle />
          </div>
        </div>
