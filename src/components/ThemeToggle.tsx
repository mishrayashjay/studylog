...
export default function ThemeToggle({ className }: ThemeToggleProps = {}) {
  ...
  return (
    <button
      ...
      className={
        className ||
        'p-2 bg-[#FDFCFB] hover:bg-warmbg dark:bg-white/5 dark:hover:bg-white/10 border border-warmborder dark:border-white/10 rounded-full text-warmtext/60 dark:text-darktext/60 hover:text-warmtext dark:hover:text-darktext transition-colors flex items-center justify-center shadow-xs'
      }
